...
<h2>
<font color="black">
<font color="white">To make payment please fill the below details</font>
</font>
</h2> <br/>
</div> 
<div class="row justify-content-center" id="align" style="padding: 10px; padding-bottom: 0px;">
...
<button class="btn btn-success" type="submit" style="margin: 10px;"><font color="greyred">Login</font></button>
<button class="btn btn-light" type="reset" style="margin: 10px;"><font color="greyred">Reset</font></button>
</div>
</form>
</div>
</div>
