...
<body>
    ...
    <sql:query var="stmt" dataSource="${mysrc}">
        ...
        select * from add_to_cart where customer_id='${sessionScope.xyz.userid}' and order_id like 'ORD%';
    ...
    <h2> <font color="white">To check the books ordered for the particular order_id press the below link</font></h2>
    <a href="ordereddetails.jsp"><font color="black">For particular Order ID</font></a>
