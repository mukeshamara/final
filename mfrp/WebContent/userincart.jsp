...
<body>
       ...
       <div class=row style="margin-top: 50px;">
 			...
 			<input type="text" class="form-control" name="username" id="username" placeholder="Enter your user id" /><br/>
                                  ...
                                  <div class="col-sm-6">
                                  <h2> <font color="white">If you want to add more books go to home page or click below link</font></h2>
                                  <br></br>
                                  <a href="lo.jsp"><font color="black">Click this to add more books</font></a>
