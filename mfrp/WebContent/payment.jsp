...
<sql:setDataSource driver="com.mysql.jdbc.Driver"
    ...
    <sql:query var="stmt" dataSource="${mysrc}">
        ...
        select p.book_id,p.book_name,p.Language,p.Delivery_Time,p.Author_Name,p.price,a.quantity_needed from product p join add_to_cart a on(a.book_id=p.book_id) where a.price_per_book>0 and order_id not like 'ORD%' and a.customer_id='${sessionScope.xyz.userid}';
    ...
    <br></br>
    <h2> <font color="white">Continue to pay please fill the below details</font></h2>
    <a href="lo.jsp"><font color="black">Otherwise Go to home page</font></a>
</div>
<div class="container">
...
<font color="white">${sessionScope.toprice}</font>
