              ...
              <div class="container" style="background-color: rgba(0, 0, 0, 0); color: white; padding: 20px;">
                           ...
                           <div class="form-row">
                                  ...
                                  <div class="col-sm-6">
                                        <h2> ${errmsg}</h2>
										<br></br>
		<h2><font color="white">Please note the customer_id :</font> ${sessionScope.customerid}</h2>
		<br></br>
                                 </div>
                                  
                                  <div class="col" style="text-align: center;">
                                         <br/>
                                         <a href="index.jsp"> <h2><font color="white">Go to login page and login again by clicking this link</font></h2></a>
                                  </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-6">
      ...
      <p><font face="verdana" color="white"> ${rs.customer_id}</font></p>
    </div>
</div>
<div class="form-group row">
...
<p><font face="verdana" color="white"> ${rs.name}</font></p>
...
<div class="form-group row">
   ...
   Date Of Birth
    ...
    <div class="col-sm-6">
     <p><font face="verdana" color="white"> ${rs.date_of_birth}</font></p>
</div>
<div class="form-group row">
    <label for="text"  class="col-sm-2 col-form-label">
    <font color="black">
    ...
    <div class="col-sm-6">
       <p><font face="verdana" color="white"> ${rs.contact_number}</font></p>
</div>
<div class="form-group row">
    <label for="text"  class="col-sm-2 col-form-label">
    <font color="black">
    ...
    <div class="col-sm-6">
     <p><font face="verdana" color="white"> ${rs.email_address}</font></p>
</div>
